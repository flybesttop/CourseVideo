                ...
                <div class="container">
                    <div id="nav-tree-c" class="breadcrumbs nav-tree-c">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <p><a href="#">主页.</a> \\ 所有课程. \\ <span>${bestObjname}.</span> \\
                                    <span>${objName}.</span></p>
                            </c:otherwise>
                        </c:choose>
                            ...
                            <ul>
                                <c:choose>
                                    <c:when test="${bestObjname==null}">
                                        <li class="selected-item"><a href="selectFreeCourse">全部</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li><a href="selectFreeCourse">全部</a></li>
                                    </c:otherwise>
                                </c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${bestObjname==bestobjs.acRelationshipsItemname}">
                                            <li class="selected-item"><a
                                                    href="selectFreeCourse?bestObjId=${bestobjs.id}"
                                                    target="_self"
                                                    bestObjId="${bestobjs.id}">${bestobjs.acRelationshipsItemname}</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                            <li><a href="selectFreeCourse?bestObjId=${bestobjs.id}" target="_self"
                                                   bestObjId="${bestobjs.id}">${bestobjs.acRelationshipsItemname}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                            ...
                            <ul>
                                <c:choose>
                                    <c:when test="${objId==null}">
                                        <li class="selected-item"><a
                                                href="selectFreeCourse">全部</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li><a href="selectFreeCourse?bestObjId=${bestObjId}">全部</a></li>
                                    </c:otherwise>
                                </c:choose>
                                ...
                                <c:forEach var="objs" items="${relationshipslevel2}">
                                    <c:choose>
                                        <c:when test="${objId==objs.acRelationshipsItemid}">
                                            <li class="selected-item"><a
                                                    href="selectFreeCourse?bestObjId=${objs.acRelationshipsParendid}&objs=${objs.acRelationshipsItemid}">${objs.acRelationshipsItemname}</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                            <li>
                                                <a href="selectFreeCourse?bestObjId=${objs.acRelationshipsParendid}&objs=${objs.acRelationshipsItemid}">${objs.acRelationshipsItemname}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                    ...
                    <div class="content">
                        ...
                        <div class="relatednews search-cloumn-4">
                            ...
                            <ul>
                                <c:forEach var="course" items="${courses}">
                                    <li>
                                        <a href="learing?courseId=${course.acCourseId}"><img
                                                src="${contextpath}/static/${course.acCourseImg}"
                                                alt="MyPassion"/></a>
                                        <p>
                                        ...
                                        <span class="playData"><i
                                                class="icon-play"></i>浏览量：<span>${course.acCoursePicknum}</span></span>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                        ...
                        <ul id="pageBox"></ul>
                        <form action="selectFreeCourse" method="get">
