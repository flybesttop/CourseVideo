            ...
            <section id="content">
                <div class="container">
                    <div id="nav-tree-c" class="breadcrumbs nav-tree-c">
                        <p><a href="#">主页.</a> \\ 新闻通知.
                            <%--\\ <span class="News-type-text">全部.</span> <span></span>--%>
                        </p>
                    </div>
                    <!-- Main Content -->
                            ...
                            <ul class="News-type">
                                <c:choose>
                                    <c:when test="${status==1}">
                                        <li id="all" style="background: #ea4748;"><a href="News" style="color: white;">全部</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li id="all"><a href="News">全部</a></li>
                                    </c:otherwise>
                                </c:choose>
                                <c:choose>
                                    <c:when test="${status==2}">
                                        <li id="information" style="background: #ea4748;"><a href="News?status=2" style="color: white;">公告</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li id="information"><a href="News?status=2">公告</a></li>
                                    </c:otherwise>
                                </c:choose>
                                <c:choose>
                                    <c:when test="${status==3}">
                                        <li id="News" style="background: #ea4748;"><a href="News?status=3" style="color: white;">新闻</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li id="News"><a href="News?status=3">新闻</a></li>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
                        </div>
                        <div class="column-three-fourth features">
                            <div id="News-list-all" class="News-list-c">
                                <ul style="width: 90%;">
                                    <c:forEach items="${newss}" var="news">
                                        <li>
                                            <c:if test="${news.acNewsType==1}">
                                                <label class="News-list-c-left">【公告】</label>
                                            </c:if>
                                            <c:if test="${news.acNewsType==2}">
                                                <label class="News-list-c-left">【新闻】</label>
                                            </c:if>
                                            <div class="News-list-c-title"><a href="News_content?NewsId=${news.acNewsId}">${news.acNewsTitle}</a></div>
                                            <div class="News-list-c-right">${news.acNewsDate} ${news.acNewsTime}</div>
                                        </li>
                                    </c:forEach>
                                    <li>
                                        <div id="All-page">
