                                                            ...
                                                            <table>
                                                                <c:if test="${lastCourse.acCourseName!=null}">
                                                                    ...
                                                                    <tr>
                                                                        <td></td>
                                                                        <td class="history-2th">
                                                                            <list>第${lastChapter}章 第${lastEpidode}节
                                                                            </list>
                                                                        </td>
                                                                    </tr>
                                                                </c:if>
                                ...
                                <li>
                                    <a class="column-active">
                                        <div class="column-active-c"
                                            ...
                                            <span style="color: white;"><i class="icon ion-ios-bookmarks"></i><span
                                                    style="color: white;">最近学习</span></span></div>
                                    </a>
                                </li>
                                <%--<li>--%>
                                <%--<a class="column-active" href="userinfo_message">--%>
                                <%--<div class="column-active-c">--%>
                                <%--<span><i class="icon ion-android-chat"></i><span>我的消息</span></span>--%>
                                <%--</div>--%>
                                <%--</a>--%>
                                <%--</li>--%>
                                <li>
                                    <a class="column-active" href="userinfo_buy?userId=${nowUser.acUserId}">
                                        <div class="column-active-c">
                                            <span><i class="icon ion-university"></i><span>我的课程</span></span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="ym-timeline">
                                <ul style="width: 100%;">
                                    <li>
                                        ...
                                        <c:choose>
                                            <c:when test="${lastCourse.acCourseName!=null}">
                                                <span class="stime">${nowUser.acUserLastlointime}</span>
                                                <div class="ym-tl-content">
                                                    <div class="learnt-c-list">
                                                        <div class="learnt-c-list-img">
                                                            <img src="${contextpath}/static/${lastCourse.acCourseImg}">
                                                        </div>
                                                        <div class="learnt-c-list-content">
                                                            <label>课程名字：${lastCourse.acCourseName}</label>
                                                            <div class="learnt-c-list-content-text"><p>
                                                                课程介绍：${lastCourse.acCourseContext}</p></div>
                                                            <div class="learnt-c-list-content-teacher">
                                                                <div class="learnt-c-list-content-teacher-text">
                                                                    开课教师：${courseteacher.acTeacherName}</div>
                                                                <div class="learnt-c-list-content-continue"><a
                                                                        href="openvideo?courseId=${lastCourseId}&chapterId=${lastChapter}&episodeId=${lastEpidode}&userId=${nowUser.acUserId}">继续学习</a>
                                                                </div>
                                                            </div>
                                                            <div class="learnt-c-list-content-menu">
                                                                上次学习到：第${lastChapter}章
                                                                第${lastEpidode}节
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <%--<li>--%>
                                    <%--<span class="diamond"></span>--%>
                                    <%--<span class="stime">2017-07-20</span>--%>
                                    <%--<div class="ym-tl-content">--%>
                                    <%--是开始 , 亦是结束--%>
                                    <%--</div>--%>
                                    <%--</li>--%>
...
<script>
    function updataUserMessage() {
        $.ajax({
            url: "updateUserMessage",
            type: "post",
            async: false,
            traditional: true,
            data: $("#changeUserMessage").serialize(),
            datatype: "text",
